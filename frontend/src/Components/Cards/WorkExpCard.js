    ...
    >
      ...
      >
        <ListGroupItem variant="info">
          ...
          <div className="personItemDetails">iOS Engineer</div>
        ...
        <ListGroupItem variant="info">
          ...
          <div className="itemInformation">
            • Developed and unit tested web, mobile, and native applications in
            various languages and frameworks including Java, Typescript,
            Javascript, Node.js, React, C, Swift in combination with several
            other technologies
          </div>
          <div className="itemInformation">
            • A list of relevant projects along with GitHub repo's and README's
            can be found in the Projects section of my Portfolio ranging from
            personal projects to projects with groups up to 7 people
          </div>
        </ListGroupItem>
        <ListGroupItem variant="info">
